...
<?php
//Actualizada a la fecha 30/05/2015
...
function traerSql($rango,$tabla,$condicion){
    if($condicion==NULL){
...
// function getCode($largoCodigo){ //descomentar la llamada a la libreria en la parte de arriba si se va a usar esta función
