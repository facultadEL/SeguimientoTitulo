...
$id_Alumno = $_REQUEST['idAlumno'];
	if ($id_Alumno == NULL){
		...
		$caracteristicaF_alumno = (empty($_REQUEST['caracteristicaF_alumno'])) ? '0' : $_REQUEST['caracteristicaF_alumno'];
		$telefono_alumno = (empty($_REQUEST['telefono_alumno'])) ? '0' : $_REQUEST['telefono_alumno'];
		...
		$cp_alumno2 = (empty($_REQUEST['cp_alumno2'])) ? '0' : $_REQUEST['cp_alumno2'];
