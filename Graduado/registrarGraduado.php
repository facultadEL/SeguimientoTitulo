...
<table align="center" id="tablaGeneral" cellpadding="2" cellspacing="2" width="100%">
	<tr width="100%">
		...
		<legend><FONT face="Cambria" size="4" color="#6E6E6E">Carrera del T&iacute;tulo a Solicitar</FONT></legend>
			...
			<tr width="100%">
				...
				<td width="50%">
					<?php 	if($id_Alumno == NULL){ ?>
						<select id="cCarrera" name="carrera_alumno" size="1" class="required">
					...
					<?php 	}else{
								...
								echo '<input id="cCarrera" name="carrera_alumno" type="hidden" value="'.$carrera_alumno.'"/>';
							}
					?>
				</td>
				<td width="10%" align="center">
					<label for="cNombre">&Uacute;ltima materia rendida: </label>
				</td>
				<td width="10%">
					<input id="UltMatRend" name="ultima_materia_alumno" type="text" value="<?php echo $ultima_materia_alumno; ?>" class="required" size="22"/>
				</td>
				<td width="10%" align="center">
					<label for="cNombre">Fecha &Uacute;lt. mat. rendida: </label>
				</td>
				<td width="10%">
					<input id="fechaUltMat" name="fecha_ultima_mat_alumno" type="text" value="<?php echo $fecha_ultima_mat_alumno; ?>" placeholder="dd-mm-aaaa" class="required" maxlength="10" size="10"/>
				</td>
			</tr>
		</table>
		</fieldset>
		...
		<legend><FONT face="Cambria" size="4" color="#6E6E6E">Datos Personales</FONT></legend>
			<table align="left" cellpadding="2" cellspacing="2" width="100%">
				<tr width="100%">
					...
					<td width="30%">
						<input id="cNombre" name="nombre_alumno" type="text" value="<?php echo $nombre_alumno; ?>" class="required" size="22"/>
					</td>
					<td width="20%" align="right">
						<label for="cApellido">Apellido: </label>
					</td>
					<td width="30%">
						<input id="cApellido" name="apellido_alumno" type="text" value="<?php echo $apellido_alumno; ?>" class="required" size="22" />
					</td>
				</tr>
				<tr width="100%">
