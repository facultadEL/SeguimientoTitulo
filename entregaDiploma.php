...
<form class="formBuscador" id="commentForm" name="buscador" action="?control=1&etapa=7&controlNoForm=1" method="post">
	<center>
...
echo '<table align="center" cellspacing="1" cellpadding="4" border="1" bgcolor=#585858 id="tabla">';
	echo '<tr bgcolor="#FFFFFF">';
		echo '<td id="titulo3" colspan="5" align="center"><l1>Listado de Alumnos - Retiro Diploma</l1></td>';
	echo '</tr>';
	if($longVector!=0){
		$habilitarBoton = '<a href="confirmarSeleccion.php?etapa=7&longVector='.$longVector.'&textPasar='.$textPasar.'" ><input type="button" name="confirmar" value="Confirmar"/></a>';
	}else{
...
echo '<p>';
if($volver == 1){
	$redireccion = "entregaDiploma.php?control=0&controlNoForm=1&textPasar=$textPasar&longVector=$longVector";
}else{
	$redireccion = "";
}
