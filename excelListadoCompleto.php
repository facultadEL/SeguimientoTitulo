...
header("content-disposition: attachment;filename=Listado Completo - $vTipoListado[$oTipoListado].xls");
...
echo '<table align="center" cellspacing="1" cellpadding="4" border="1" bgcolor=#585858 id="tabla">';
	...
	echo '<td id="titulo3" colspan="'.$cantidadCol.'" align="center"><l1>Listado '.$vTipoListado[$oTipoListado].'</l1></td>';
	echo '</tr>';
	echo '<tr bgcolor="#FFFFFF">';
		echo '<td id="titulo3" colspan="'.$cantidadCol.'" align="left"><l1>Cantidad de alumnos: '.$cantidad.'</l1></td>';
	echo '</tr>';
