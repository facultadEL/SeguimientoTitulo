...
echo '<form class="formBuscador" id="commentForm" name="buscador2" action="?control=2" method="post" >';
	echo '<tr bgcolor="#FFFFFF">';
		...
		echo '<td id="titulo3" colspan="6" align="center"><l1>Buscar:</l1>&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="palabra" value="'.$palabra.'" onChange="submit()" /></td>';
	echo '</tr>';
echo '</form>';

if($controlCant!=0){
	echo '<tr bgcolor="#FFFFFF">';
		echo '<td id="titulo3" colspan="6" align="center"><l1>'.$controlCant.' resultados encontrados</l1></td>';
	echo '</tr>';
	echo '<tr bgcolor="#FFFFFF">';
		echo '<td id="titulo3" colspan="6" align="center"><l1><a href="excelListadoCompleto.php?palabra='.$palabra.'&oTipoListado='.$oTipoListado.'&cantidad='.$controlCant.'"><input type="button" value="Excel"/></a>&nbsp;&nbsp;<a href="pantallaListadoCompleto.php?palabra='.$palabra.'&oTipoListado='.$oTipoListado.'&cantidad='.$controlCant.'"><input type="button" value="Imprimir"/></a></l1></td>';
	echo '</tr>';
}
