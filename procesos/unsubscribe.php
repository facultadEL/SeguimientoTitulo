...
$cuerpo = "El siguiente alumno se ha dado de baja: <br/> <b>ID:</b> {id} <br/> <b>Nombre:</b> {nombre} <br/> <b>Apellido:</b> {apellido} <br/> <b>Mail:</b> {mail} <br/> <b>Motivo:</b> {motivo} <br/> <b>Sistema origen:</b> Seguimiento de Título;";
$asunto = "Seguimiento de título dado de baja";
