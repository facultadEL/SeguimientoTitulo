...
<form class="formBuscador" id="commentForm" name="buscador" action="?control=1&etapa=4&controlNoForm=1" method="post">
	<center>
...
<form class="formResCd" id="form" name="resolucion_cd" action="?etapa=4" method="post">
<?php


echo '<table align="center" cellspacing="1" cellpadding="4" border="1" bgcolor=#585858 id="tabla">';
	echo '<tr bgcolor="#FFFFFF">';
		echo '<td id="titulo3" colspan="5" align="center"><l1>Listado de Alumnos - Consejo Superior</l1></td>';
	echo '</tr>';
	echo '<tr bgcolor="#FFFFFF">';
	...
	if($longVector!=0 && $nroResolucion != '' && $fechaResolucion != ''){
		$habilitarBoton = '<a href="confirmarSeleccion.php?etapa=4&longVector='.$longVector.'&textPasar='.$textPasar.'&nroResolucion='.$nroResolucion.'&fechaResolucion='.$fechaResolucion.'" ><input type="button" name="confirmar" value="Confirmar"/></a>';
	}else{
...
echo '<p>';
if($volver == 1){
	$redireccion = "resolucionCs.php?nroResolucion=$nroResolucion&fechaResolucion=$fechaResolucion";
}else{
	$redireccion = "";
}
