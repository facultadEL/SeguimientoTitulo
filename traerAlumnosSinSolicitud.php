...
while($rowSolicitud = pg_fetch_array($sqlSolicitud))
{
	...
	$html .= '<td><a href="mostrarAlumno.php?idAlumno='.$idAlumno.'&idCarrera='.$idCarrera.'&origen=listadoSinSolicitudTitulo" >'.$rowSolicitud['apellido_alumno'].', '.$rowSolicitud['nombre_alumno'].'</a></td>';
